...
if(isset($_POST['email'])) {
    ...
    $email_to = "sara.adkins65@gmail.com";
    $email_subject = "SaraAdkins.com Form Response!";
    ...
    function died($error) {
        ...
        echo $error."<br /><br />";
        echo "Please go back and fix the errors, then resubmit.<br /><br />";
        die();
    }
...
if($error == false) {
    died("Server Error. Mail vailed to send");
}
?>
